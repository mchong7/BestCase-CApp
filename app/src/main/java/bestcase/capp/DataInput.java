                ...
                public void onClick(View v) {
                    ...
                    if (twoUnknowns)
                    {
                        ...
                        // Case 4: solve for displacement and time
                            ...
                            if (a == 0) {
                                if (vel != v0) {
                                    error = "Current input values result in division by zero." +
                                        "Please input a nonzero value for acceleration. (Equal velocities also results in an error)";
                                } 
                                else {
                                    error = "The current value of the inputs result in an infinite combinations of values for displacement and time." +
                                        "Please input a nonzero value for acceleration.";
                                }
                            } 
                            else {
                        ...
                        // Case 5: solve for displacement and acceleration
                            ...
                            if (dt == 0) {
                                if (vel == v0) {
                                    ...
                                    error = "The current inputs imply infinite acceleration, since there is a change in velocity in zero time." +
                                        "Please change the velocity inputs or input time as a nonzero value.";
                                }
                            } 
                            else {
                                a = (vel - v0) / dt;
                        ...
                        // Case 8: solve for acceleration and final velocity
                            ...
                            if (dt == 0.0) {
                                if (dx == 0.0) {
                                    ...
                                    error = "The current inputs are not physically possible. There cannot be displacement in zero time." +
                                        "Please input time as a nonzero number or displacement as zero.";
                                }
                            } 
                            else {
                                a = 2 / (dt * dt) * (dx - v0 * dt);
                        ...
                        // Case 9: solve for initial velocity and final velocity
                            ...
                            if (dt == 0.0) {
                                if (dx == 0.0) {
                                    error = "The inputs provided are not enough to find initial and final velocity." +
                                        "Please change either the displacement or time values to be nonzero.";
                                } else {
                                    error = "The current inputs are not physically possible. There cannot be displacement in zero time." +
                                        "Please input time as a nonzero number or displacement as zero.";
                                 }
