        ...
        solve.setOnClickListener(new View.OnClickListener()
             {
                 public void onClick(View v)
                 {
                     ...
                     if ((isEmpty(text_initial_vel) && isEmpty(text_final_vel) && isEmpty(text_accel)) ||
                             ...
                             (isEmpty(text_final_vel) && isEmpty(text_accel) && isEmpty(text_accel)) ||
                         ...
                         error = "You have not input enough variables.";
                     }
                     ...
                     if (error == "") {
                         ...
                         System.out.print("Time: " + dt + " seconds.");
                         System.out.print("Displacement: " + dx + " meters.");
